...
describe('Specification tests', (): void => {
  ...
  it.each([
    ...
    //[singleError, [{humanReadable: `'Julien' is not included in the registered users list`, inputKey: "clientIdentity", inputValue: "Julien", rule: "isRegisteredUser"}]],
    //[multipleErrors, [
    //    {humanReadable: `'Julien' is not included in the registered users list`, inputKey: "clientIdentity", inputValue: "Julien", rule: "isRegisteredUser"},
    //    {humanReadable: "", inputKey: "", inputValue: "undefined", rule: "string"},
    //]],
